...
- This is a rock-paper-scissard-lizard-spock, game fully responsive.



# The goals of this website are:

- A way to have fun and whit a very easy way to play and a visual score count.
...
## UX
- My ideas it was to do something very simple with no real problems, just enter and enjoy.

## Ideal Users

# The ideal Users for this site is:

- Everyone can use this site

# The project help users to:

- See clear  they score and the computer choices, also is giving you a restart as soons as someone wins.

- Instrustions in how to play, clikcleable buttons to play, emojis for your visial pick, a play button and a automatic restart as soons as the game is over.
...
# Home
- The home page have all the detais you need, Rules and Notes for you to understant waht to do.


## Due to lack of information and time:

1. Add Start game Screen
2. Music 
3. A endgame screen with animations
4. Animation logos wnet the computer is picking
5. Option to choose languages.

## This project uses HTML, CSS  and Js programming  languages.
...
# Deployment
1. This project was developed using Gitpod, committed to git and pushed to GitHub using git commands.

2. To deploy this page to GitHub Pages from its GitHub repository, the following steps were taken:

3. Log into GitHub.

4. From the list of repositories on the screen, select saranamdarian.

5.  From the menu items near the top of the page, select Settings.

6. Scroll down to the GitHub Pages section.

7. Under Source click the drop-down menu labelled None and select Master Branch. Then Save it.

8. Wait for a few minutes of the website to be deployed.

9. Scroll back down to the GitHub Pages section to access the link to the deployed website.

10. Run this project locally

11. Select the Repository from the GitHub Dashboard.

12. Click the green button labelled 'Code'.

13. Click 'Download ZIP'.

14. Extract ZIP file on your computer.

15. Open folder and open index.html in web browser.

16. Clone this project

17. Select the Repository from the GitHub Dashboard.

18. Click the green button labelled 'Code'.

19. To clone the repository using: -- HTTPS: under "Clone with HTTPS", click checklist icon. -- SSH: click Use SSH, then click checklist icon.
20. Open Git Bash.

21. Change the current working directory to the location where you want the cloned directory.

22. Type 'git clone', and then paste the URL you copied earlier.

23. Press Enter to create your local clone.

# Credits

- Content

- The texts for all the pages have been created by Diego Hernandez.
